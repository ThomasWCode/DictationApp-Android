...
| Sentences and pauses | AssemblyAI waits for 1 s of silence before ending a sentence at a full stop (its default is 100 ms), so a pause to think no longer splits a sentence in two. The cleanup is also told to rejoin fragments cut at pauses. |
